...
@Component({
    ...
    templateUrl: './consulta-plano-ensino.component.html',
    styleUrls: ['./consulta-plano-ensino.component.scss'],
    animations: [routerTransition()]
})
export class ConsultaPlanoDeEnsinoComponent implements OnInit {
    ...
    ngOnInit() {
      /**SETA O TÍTULO */
      this.titulo = "Planos de Ensino Cadastrados";
