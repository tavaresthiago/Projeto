...
@Component({
    ...
    templateUrl: './cadastra-plano-ensino.component.html',
    styleUrls: ['./cadastra-plano-ensino.component.scss'],
    animations: [routerTransition()]
})
export class CadastraPlanoDeEnsinoComponent implements OnInit {
    ...
    ngOnInit() {
      this.activatedRoute.params.subscribe(parametro => {
        if(parametro["id"] == undefined){
          this.titulo = "Cadastro de Plano de Ensino";
        }else{
          this.titulo = "Editar Plano de Ensino";
