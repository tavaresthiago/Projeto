...
@Component({
    ...
    templateUrl: './consulta-ppc.component.html',
    styleUrls: ['./consulta-ppc.component.scss'],
    animations: [routerTransition()]
})
export class ConsultaPpcComponent implements OnInit {
    ...
    editar(id:number):void{
      ...
      this.router.navigate(['/edita-ppc',/*id*/]);
