...
@Component({
    selector: 'app-cadastra-ppc',
    templateUrl: './cadastra-ppc.component.html',
    styleUrls: ['./cadastra-ppc.component.scss'],
    animations: [routerTransition()]
})
export class CadastraPpcComponent implements OnInit {
    ...
    ngOnInit() {
      this.activatedRoute.params.subscribe(parametro => {
        if(parametro["id"] == undefined){
          this.titulo = "Cadastro de PPC";
        }else{
          this.titulo = "Editar PPC";
